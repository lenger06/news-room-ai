...
SHOWS: dict[str, Show] = {
    ...
    "morning-report": Show(
        ...
        desk_anchors={
            ...
            "business":       DeskAssignment("Lars Whitfield",    ""),
    ...
    "evening-news": Show(
        ...
        desk_anchors={
            ...
            "politics":       DeskAssignment("Erik Sinclair",      "formal", alt_anchor_name="Victor Marinos", alt_every=3),
            "foreign":        DeskAssignment("Erik Sinclair",      "formal", alt_anchor_name="Victor Marinos", alt_every=3),
    ...
    "special-report": Show(
        ...
        video_style="pip_v3_chromakey",
        desk_anchors={
            "national":       DeskAssignment("Erik Sinclair", ""),
            "politics":       DeskAssignment("Erik Sinclair", ""),
            "foreign":        DeskAssignment("Erik Sinclair", ""),
            "business":       DeskAssignment("Erik Sinclair", ""),
            "health_science": DeskAssignment("Erik Sinclair", ""),
            "investigative":  DeskAssignment("Erik Sinclair", ""),
            "entertainment":  DeskAssignment("Erik Sinclair", ""),
        },
    ),
    ...
    "breaking-news": Show(
        ...
        desk_anchors={
            ...
            "foreign":        DeskAssignment("Erik Sinclair",      "formal"),
            "business":       DeskAssignment("Lars Whitfield",    "formal"),
