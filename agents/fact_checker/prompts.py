...
2. For each significant claim, use the web_research_tool to search for corroborating or contradicting evidence
3. Focus on the most important claims first (lead paragraph facts, statistics, attributed quotes)
4. You do not need to verify obvious background knowledge — focus on specific, checkable facts
